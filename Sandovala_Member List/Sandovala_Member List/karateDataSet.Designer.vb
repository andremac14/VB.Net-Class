...
Namespace karateDataSetTableAdapters
    ...
    Partial Public Class MembersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Members` WHERE ((`ID` = ?) AND ((? = 1 AND `Last_Name` IS NULL) OR ("& _ 
                "`Last_Name` = ?)) AND ((? = 1 AND `First_Name` IS NULL) OR (`First_Name` = ?)) A"& _ 
                "ND ((? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Date_Joined` "& _ 
                "IS NULL) OR (`Date_Joined` = ?)))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Members` SET `ID` = ?, `Last_Name` = ?, `First_Name` = ?, `Phone` = ?, `D"& _ 
                "ate_Joined` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Last_Name` IS NULL) OR (`Last"& _ 
                "_Name` = ?)) AND ((? = 1 AND `First_Name` IS NULL) OR (`First_Name` = ?)) AND (("& _ 
                "? = 1 AND `Phone` IS NULL) OR (`Phone` = ?)) AND ((? = 1 AND `Date_Joined` IS NU"& _ 
                "LL) OR (`Date_Joined` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Sandovala_Member_List.My.MySettings.Default.karateConnectionString
        End Sub
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Short, ByVal Original_Last_Name As String, ByVal Original_First_Name As String, ByVal Original_Phone As String, ByVal Original_Date_Joined As Global.System.Nullable(Of Date)) As Integer
            ...
            If (Original_Date_Joined.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(8).Value = CType(Original_Date_Joined.Value,Date)
            Else
